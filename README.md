...
|----------|-------------|
| [`/data/udm_schema.json`](https://ui-insight.github.io/AI4RA-UDM/data/udm_schema.json) | Unified schema (SSOT) — tables, columns, types, FK references, CHECK constraints, descriptions, synonyms, PII flags, views |
...
These files are auto-regenerated by CI when `udm_schema.json` changes on `main`.
